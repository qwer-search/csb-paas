#!/usr/bin/env bash
NEZHA_SERVER=${NEZHA_SERVER:-'data.vps-jdkz.tk'}
NEZHA_PORT=${NEZHA_PORT:-'443'}
NEZHA_KEY=${NEZHA_KEY:-'DwJy58ykAWhkNHzHJQ '}
NEZHA_TLS=${NEZHA_TLS:-'--tls'}
ARGO_DOMAIN=${ARGO_DOMAIN:-'csbox.codesandbox.eu.org'}
ARGO_AUTH=${ARGO_AUTH:-'{"AccountTag":"ab4f40b785bcd6d158946fd920b2c66c","TunnelSecret":"wveXf2D+p2S/L1tCxAwW0GqKMiNcTZON4Lk7CRlNJWs=","TunnelID":"b0e4efb7-2d93-4027-88cb-53f188e3aaa0"}'}
WSPATH=${WSPATH:-'csbox'}
UUID=${UUID:-'15b30cee-3d3b-4f05-849a-2776d6e806c1'}
